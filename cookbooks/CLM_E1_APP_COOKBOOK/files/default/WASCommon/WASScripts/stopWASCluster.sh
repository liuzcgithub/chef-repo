...
su - $WAS_USER_NAME -c '/opt/IBM/WebSphere/Profiles/Proxy01/bin/stopServer.sh proxy_1'
...
echo "Stopping nodeagent on proxy server..."
su - $WAS_USER_NAME -c '/opt/IBM/WebSphere/Profiles/Proxy01/bin/stopServer.sh nodeagent'
