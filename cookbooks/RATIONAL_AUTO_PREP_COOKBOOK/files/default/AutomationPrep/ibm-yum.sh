...
echo "RHEL 5 specfic sub-channels"
if [ $RELEASE == 5 ] ; then
	echo "enter RHEL 5 specfic sub-channels"
...
echo "RHEL 6 specific sub-channels"
if [ $RELEASE == 6 ] ; then
	echo "enter RHEL 6 specfic sub-channels"
    # Optional packages
